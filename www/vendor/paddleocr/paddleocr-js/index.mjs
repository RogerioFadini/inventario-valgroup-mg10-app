...
import ClipperLib from "../clipper-lib/clipper-lib-shim.mjs";
import cvModule from "../opencv-js/opencv-js-shim.mjs";
...
async function loadOrtModule() {
  ...
  ortModulePromise = import("../onnxruntime-web/ort.min.mjs");
  return ortModulePromise;
}
